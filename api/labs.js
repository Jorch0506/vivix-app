...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const sys = 'Eres interprete de laboratorios de VIVIX. ' + (langs[lang] || langs.es) + ' Responde SOLO con JSON: {"resumen":"texto","vital_insight":"accion","plan_accion":[{"titulo":"titulo","descripcion":"descripcion","plazo":"plazo"}],"categorias":[{"nombre":"cat","parametros":[{"nombre":"n","valor":"v","referencia":"r","estado":"Optimo|Aceptable|Atencion|Critico","nota":"n"}]}],"alerta_medica":null}';
